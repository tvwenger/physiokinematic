...
See `distance_model.ipynb` for a demonstration.
...
See `hii_region_model.ipynb` for a demonstration.

See also `model_demonstration.ipynb` for a Monte Carlo demonstration of the model architecture.
